...
This travel catalogue application developed and deployed using MS Azure Cloud and users can add travel destinations, view all destinations and filter the catalogue using different attributes. The web application is named \textbf{U-AT\_lasTravel}.
...
\section{Additional Cloud Feature Integration}
